...
import { createFighter } from '../../src/fighters/phantom.js';
import { updateFighter } from '../../src/fighters/phantom.js';
...
function triggerSkill(phantom, enemy) {
  phantom._skillCooldown = 0;
  const alive = [phantom, enemy].filter(f => f.alive);
  updateFighter(phantom, alive, makeState(enemy));
}

describe('phantom teleport skill', () => {
